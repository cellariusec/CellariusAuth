...
func main() {
	...
	config.AllowOrigins = []string{"http://localhost:3000", "https://cellariusec-cellarius-web-store-bul4-dy8ws7h5d.vercel.app", "https://cellariusec-cellarius-web-store-szvk.vercel.app", "https://verbose-orbit-ppxqpr7g9q6f6g4.github.dev", "http://localhost:8080"}
