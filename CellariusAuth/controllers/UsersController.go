...
func Login(c *gin.Context) {
 ...
 sessionjwt,err := util.GenerateJWTs(c)
 if err != nil{
...
/*
curl -X POST -H "Content-Type: application/json" -d '{"Email":"example@example.com","Password":"password123"}' http://localhost:3000/signup
*/
